...
import { api, UserProfile, ProfileStatistics, UserAchievement } from "../services/api";
          ...
          {stats && (
            <div className="px-8 py-6 border-b border-border">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-gradient-to-br from-amber/20 to-amber-dark/20 border border-amber/30 rounded-xl p-4 hover:shadow-lg hover:shadow-amber-glow transition-all">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs font-semibold text-muted-foreground uppercase">Streak</span>
                  </div>
                  <div className="text-3xl font-bold text-amber">{stats.currentStreak}</div>
                ...
                <div className="bg-gradient-to-br from-cyan/20 to-cyan-dark/20 border border-cyan/30 rounded-xl p-4 hover:shadow-lg hover:shadow-cyan-glow transition-all">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-2xl">📚</span>
                    <span className="text-xs font-semibold text-muted-foreground uppercase">Reviewed</span>
                  </div>
                  <div className="text-3xl font-bold text-cyan">{stats.totalCardsReviewed}</div>
                  <div className="text-xs text-muted-foreground mt-1">cards total</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-cyan/20 to-cyan-dark/20 border border-cyan/30 rounded-xl p-4 hover:shadow-lg hover:shadow-cyan-glow transition-all">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-2xl">⭐</span>
                    <span className="text-xs font-semibold text-muted-foreground uppercase">Mastered</span>
                  </div>
                  <div className="text-3xl font-bold text-cyan">{stats.totalCardsMastered}</div>
                  <div className="text-xs text-muted-foreground mt-1">cards learned</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-amber/20 to-amber-dark/20 border border-amber/30 rounded-xl p-4 hover:shadow-lg hover:shadow-amber-glow transition-all">
                  ...
                  <div className="text-3xl font-bold text-amber">{stats.totalStudyDays}</div>
                  <div className="text-xs text-muted-foreground mt-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                {/* Active Decks */}
                <div className="bg-muted/50 rounded-lg p-4 border border-border">
                  <div className="text-sm text-muted-foreground mb-1">Active Decks</div>
                  <div className="text-xl font-bold text-foreground">{stats.activeDecksCount}</div>
                </div>
              </div>
            </div>
          )}
                      ...
                      .map((achievement) => (
                        ...
                        >
                          <div className="flex items-start gap-3">
                            <div className="text-3xl flex-shrink-0">{achievement.badgeIcon}</div>
                            <div className="flex-1 min-w-0">
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-start gap-3 mb-3">
                              <div className="text-2xl flex-shrink-0 opacity-50">{achievement.badgeIcon}</div>
                              <div className="flex-1 min-w-0">
                              ...
                              <div className="w-full bg-muted rounded-full h-2 overflow-hidden">
                                <motion.div
                                  ...
                                  className={`h-full rounded-full ${
                                    progressPercent >= 75 ? 'bg-gradient-to-r from-cyan to-cyan-dark shadow-sm shadow-cyan-glow' :
                                    progressPercent >= 50 ? 'bg-cyan' :
                                    progressPercent >= 25 ? 'bg-amber' :
                                    'bg-muted-foreground'
                                  }`}
                                />
                              </div>
