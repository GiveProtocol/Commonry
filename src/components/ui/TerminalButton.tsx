  ...
  return (
    <button
      ...
      className={cn(
        ...
        "before:z-[-1]",
        variant === "cyan" &&
          "before:bg-terminal-primary hover:text-paper dark:before:bg-cyan dark:hover:text-dark",
        variant === "amber" &&
          "before:bg-terminal-accent hover:text-paper dark:before:bg-amber dark:hover:text-dark",
        "hover:before:left-0",
